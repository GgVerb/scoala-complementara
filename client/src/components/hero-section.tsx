...
export default function HeroSection() {
  const quotes = [
    ...
    {
      text: "Natura este profesorul suprem. În liniștea ei, fiecare suflet își găsește lecția.",
      author: "Ralph Waldo Emerson"
    },
    {
      text: "Natura este sursa adevăratei cunoașteri. Ea are propria sa logică, propriile legi.",
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          <div className="mb-6">
            <div className="rotating-banners">
              <div className="banner active">
                ...
                <span className="banner-separator" style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8), -1px -1px 2px rgba(0,0,0,0.8), 1px -1px 2px rgba(0,0,0,0.8), -1px 1px 2px rgba(0,0,0,0.8)'}}>-</span>
          ...
          <div className="text-2xl sm:text-3xl mb-8 text-gray-100 font-bold leading-relaxed min-h-[120px] flex flex-col justify-center">
            ...
            <p className={`text-xl text-accent font-bold mt-2 transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`} style={{textShadow: '2px 2px 4px rgba(0,0,0,0.8), -1px -1px 2px rgba(0,0,0,0.8), 1px -1px 2px rgba(0,0,0,0.8), -1px 1px 2px rgba(0,0,0,0.8)'}}>
